            ...
            .HasData(
                new ArtistTranslation
                {
                    ...
                    Description = "Lucas Achtschellinck est un peintre brabançon baroque spécialisé dans la peinture de paysages. "
                        + "Il est né à Bruxelles en 1626, fut baptisé le 16 janvier de la même année. "
                        + "Il entre dans la guilde des peintres le 29 octobre 1639 comme élève de Pieter van der Borcht. " 
                        + "En 1655, à la mort de Lodewijk de Vadder, il pose sa candidature pour devenir cartonnier privilégié de la ville de Bruxelles. "
                        + "Un voyage à l'étranger peut être envisagé, puisqu'il n'est admis maître qu'en 1657. En 1659, il reçoit 120 florins pour un tableau exécuté à Sainte Gudule. "
                        + "En 1660 Corneille de Bie publie le Gulden Cabinet dans lequel il décrit le style de Lucas Achtschellinck. En 1662, il reçoit 120 florins pour un tableau exécuté à Sainte Gudule. "
                        + "En 1671, il collabore avec le peintre malinois Lucas Franchois et est payé pour cela en 1673. Le 13 mai 1674, il épouse Anna Parys à l'église du Finistère à Bruxelles. " 
                        ...
                        + "Lucas Achtschellinck est souvent associé à son professeur de peinture Lodewijk de Vadder (1605-1655), ainsi qu'à Jacques d'Arthois (1603-1686). En effet, on les appelle les peintres de la Forêt de Soignes.",
                ...
                new ArtistTranslation
                {
                    ...
                    ArtistId = 4,
                    LanguageId = 3,
                    Description = "Artus Wolffort, Artus Wolffaert or Artus Wolffaerts (1581–1641) was a Flemish painter known mainly for his history paintings depicting religious and mythological scenes. "
                ...
                new ArtistTranslation
                {
                    ...
                    ArtistId = 6,
                    LanguageId = 3,
                    Description = "Sir Peter Lely (14 September 1618 – 7 December 1680) was a painter of Dutch origin whose career was nearly all spent in England, where he became the dominant portrait painter to the court. "
