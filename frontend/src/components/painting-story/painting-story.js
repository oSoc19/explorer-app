...
class PaintingStory extends React.Component{
    ...
    renderLink(param) {
        ...
        switch(param) {
            case 'technique':
            case 'tecnique':
                return (<a className="technique" href={`#Technique-${this.props.paintingId}`} id={styles.storyLink}>{Translation.Translate("learnMore")}</a>)
            case 'style':
            case 'sttle':
                return (<a className="movement" href={`#Movement-${this.props.paintingId}`} id={styles.storyLink}>{Translation.Translate("learnMore")}</a>)
            case 'artwork':
                return (<a className="description" href={`#Description-${this.props.paintingId}`} id={styles.storyLink}>{Translation.Translate("learnMore")}</a>)
            case 'artist':
                return (<a className="artist" href={`#Artist--${this.props.paintingId}`} id={styles.storyLink}>{Translation.Translate("learnMore")}</a>)
            case 'title':
                return null;
            default:
                return param;
